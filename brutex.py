...
\033[1;97m➤ \033[1;92mTool BruteX is created by bruterJam 
\033[1;92m""")
...
# main script start
os.system("xdg-open https://youtube.com/@garamkulfa")
time.sleep(5)
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://instagram.com/jamyasir09")
            
			elif fol == '2' or fol == '02':
				print()
				print("\033[1;91m[*] \033[1;97mOpening my Facebook page in your device \n")
				time.sleep(1)
				os.system("xdg-open https://www.facebook.com/jamyasir.jam.581?mibextid=ZbWKwL")
				...
				time.sleep(1)
				os.system("xdg-open https://t.me/bruterJam")
